        ...
        <div class="right_col" role="main">
          ...
          <?php //print_r($allpromoList); ?>
              <div class="col-md-12 col-sm-12 col-xs-12">
                <form class="editable" method="POST" action="<?php echo site_url('Backend/Payment/generateCMemo'); ?>" enctype="multipart/form-date">
                  <div class="x_panel">
                    <div class="x_title">
                      <h2>Payment Info <small>Generate Cash Memo </small></h2>
                      <ul class="nav navbar-right"> 
                       <button type="submit" class="btn btn-sm btn-success"> Generate CMemo </button>
                      </ul>
                      <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
   ...
   <script>
    ...
    <script>
      ...
      $('form.editable').submit(function(){ 
          if (! $('#table_records')[0].checked){
             alert('Please at least check one of the Merchant !');
             return false;
          }
