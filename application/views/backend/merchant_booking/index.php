          ...
          <?php //print_r($allpromoList); ?>
              <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php } ?>
                  <form class="form-horizontal form-label-left" method="post" action="<?php echo site_url('Backend/MerchantBooking/store'); ?>" enctype="multipart/form-data">
                    <div class="row" style="padding: 0px;margin: 0px;">
                      <div class="col-md-8 col-xs-12 col-md-offset-2">
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="city">Merchant Name</label>
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            <select class="select2_single1 form-control promoFunction" tabindex="-1" name="merchant_id" id="merchant_id">
                              <option></option>
                              <?php foreach ($ClientDetails as $merchent): ?>
                                <option value="<?php echo $merchent->id; ?>" <?php if ($old_merchent_id == $merchent->id): ?> selected="selected" <?php endif ?>> 
                                  <?php echo $merchent->business_name; ?>
                                </option>
                              <?php endforeach; ?> 
                            </select>
                          </div>
                ...
                </div>    <link href="<?php echo base_url("resource/vendors/select2/dist/css/select2.min.css"); ?>" rel="stylesheet">
            <!-- end table -->
          </div>
        </div>
        <!-- /page content -->
    ...
    <!-- /validator -->
     ...
     <script>
      $(document).ready(function() {
        ...
        //     var formURL  = "<?php echo site_url('Backend/MerchantBooking/promoViewFunction'); ?>";
        //     alert(merchant_id);
        //    $.ajax(
        //       {
        //         url : formURL,
