    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-10 col-xs-12 text-center col-lg-offset-4 col-md-offsert-4 col-sm-offset-2 well" >
          <img src="<?php echo base_url("resource/images/asap-logo-border.png") ?>" alt="asapdeliveries.com.bd" class="img-resonsive">
            <br><br>
            <h4 class="modal-title text-center" id="myModalLabel" style="color: #f05034;">Welcome to ASAP Deliveries Portal</h4><br><br>
            <form method="post" enctype="multipart/form-data" action="<?php echo site_url('CDashboard'); ?>">
                <div class="row">
